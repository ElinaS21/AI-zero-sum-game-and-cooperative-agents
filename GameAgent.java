...
public abstract class GameAgent extends Agent{
    ...
    public GameAgent(int agentType, int position, int peopleInCar) {
    ...
    private StateNode evalNextNode(StateNode parent, int nextPosition, boolean isAgent) {
        ...
        StateNode next = null;
        LinkedList <StateNode> children = new LinkedList <StateNode>();
        ...
        StateNode res = new StateNode(agentPosition, opponentPosition, peopleArr, peopleInAgentCar, peopleInOpponentCar, agentScore,
                opponentScore, time, /*heuristic*/0, prev, next,children, depth);
  ...
  //return sub tree result
    private void evaluateSubTree(StateNode parent) {
        ...
        /*
         * if depth is even then calc agent move
         * if depth is odd then calc opponent move
         */
        int position;
        ...
        sortChildren(parent.children, parent);
           
        //start eval children
        for(StateNode n : parent.children) {
